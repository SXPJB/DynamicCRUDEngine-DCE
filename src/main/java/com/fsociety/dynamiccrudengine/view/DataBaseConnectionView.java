...
public class DataBaseConnectionView extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        if (validateField().equals("Exito")) {
            ...
            if (!dataBaseConnectionController.dataBaseConnection(hostTextField.getText(), userTextField.getText(), new String(passwordField.getPassword()), databaseTextField.getText())) {
                return;
            }
